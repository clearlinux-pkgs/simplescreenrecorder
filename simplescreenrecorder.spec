...
Version  : 0.4.4
Release  : 7
URL      : https://github.com/MaartenBaert/ssr/archive/0.4.4/ssr-0.4.4.tar.gz
Source0  : https://github.com/MaartenBaert/ssr/archive/0.4.4/ssr-0.4.4.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1648667085
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/ssr-0.4.4/COPYING %{buildroot}/usr/share/package-licenses/simplescreenrecorder/8624bcdae55baeef00cd11d5dfcfa60f68710a02
pushd clr-build
%make_install
popd
